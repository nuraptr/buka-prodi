...
if(isset($_POST['submit'])){
  ...
  $login = mysqli_query($dbconnect, "SELECT * FROM user WHERE email = '$email' AND pass=md5('$pass')");
  $row=mysqli_fetch_array($login);
  if ($row['email'] == $email AND $row['pass'] == md5($pass) AND $row['level_user'] == 'pengusul')
  {
    session_start();
    ...
    $_SESSION['level_user'] = $row['level_user'];
      ...
      header('location:on-pengusul/index.php');
}else{
  ...
  <div class="page-wrapper" >
    ...
    <div class="page-container" style="margin-top: 0px;">
        ...
        <div class="page-content col-md-7">
            <div style="margin: 100px;" class="col-md-9 col-md-offset-2">
                ...
                <div class="col" style="margin-top: 30px;">
                    ...
                    <div class="input-group">
                        ...
                        <input id="email" type="text" class="form-control" name="email" value="" placeholder="Masukkan email" required>                          
                    </div><br>
                    <div class="input-group">
            ...
            <div class="form-group">
              <p class="text-center m-t-xs text-sm" style="color: white;">Belum memiliki akun?</p> 
              <a href="register.php" class="btn btn-primary btn-block m-t-md">Register</a>
          </div>
