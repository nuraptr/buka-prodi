        ...
        <div class="page-content-wrapper" id="page-content-wrapper">
          ...
          <div class="page-content">
            ...
            <div class="row" style="background-color: #f5f5f5; border: 1px solid #e3e3e3;margin: 20px;padding-bottom: 15px;">
              <div class="col-md-12">
                <h3 style="padding-left: 10px;color: #6b3e0d;"><b>Pengumuman SILEMKERMA</b></h3>
                <hr>
                <?php
                  $cekStatus = mysqli_query($dbconnect, "SELECT status FROM data_input WHERE id_pengusul= '$id_pengusul'");
                      $hCekStatus = mysqli_fetch_assoc($cekStatus);
                      if ( $hCekStatus['status'] == 'Diterima'){
                        echo '<div style= "text-align: center"; >
                        <h4><b>SELAMAT!</b></h4>
                        <p>Pengusulan pembukaan program studi anda diterima.</p>
                        </div>';
                      }elseif($hCekStatus['status'] == 'Ditolak'){
                        echo '<div style= "text-align: center"; >
                        <h4><b>MAAF!</b></h4>
                        <p>Pengusulan pembukaan program studi anda belum dapat diterima.</p>
                        </div>';
                      }else{
                        echo '<div class="note note-warning">Sedang proses pengusulan atau anda belum mengusulkan.</div>';
