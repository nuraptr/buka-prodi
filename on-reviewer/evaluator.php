							...
							<div class="col-md-6">
								...
								<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											<span class="caption-subject font-blue bold uppercase">Tentukan Evaluator</span>
										</div>
									</div>
									<div class="portlet-body">
										...
										if(isset($_POST["submit"])){
											...
											for ($i = 0; $i <count($evaluator);$i++){
												...
												$berhasil = mysqli_query($dbconnect, "INSERT INTO evaluator VALUES ('$id_pengusul', '$evaluator[$i]')");
											}
											if ($berhasil) {
												echo '
												<div class="note note-warning">Berhasil menentukan evaluator.</div>';
											}
										}
										?>
										...
										<form action="" method="POST">
											<div class="form-group">
												<div class="mt-checkbox-list">
													<?php
													$q1 = mysqli_query($dbconnect, "SELECT nip_user FROM user WHERE level_user = 'evaluator'");
													while ($hasil= mysqli_fetch_assoc($q1)) {
														echo '

														<label class="mt-checkbox mt-checkbox-outline">'.$hasil['nip_user'].'
														<input type="checkbox" value="'.$hasil['nip_user'].'" name="evaluator[]" />
														<span></span>
														</label>';
													}
