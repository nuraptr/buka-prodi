        ...
        <div class="page-content-wrapper" id="page-content-wrapper">
         ...
         <div class="row">
              ...
              <div class="portlet-body">
                <div class="help-block">
                  ...
                  if ($dataa['proposal'] != NULL) {
                    ...
                    echo '
                    <h5><b>Proposal</b></h5>
                    <p><a href="../on-pengusul/'.$folder.'/'.$dataa['proposal'].'" download><img src="../img/d.png" width="1%;">  Download Proposal</a></p>';
                    ...
                    if ($dataa['lampiran'] != NULL) {
                      ...
                      for($z = 0; $z < count($a); $z++){
                        $folder = $dataa['id_pengusul']."-".$dataa['jenjang']."-".$dataa['nama'];
                        echo '
                        <p><a href="../on-pengusul/'.$folder.'/'.$a[$z].'" download><img src="../img/d.png" width="1%;">'.$a[$z].'</a></p>';
                      } 
                    }
                  }
                  ?>
          ...
          <div class="row" style="margin: 5px;">
            <div class="col-md-12">
              <div class="portlet light bordered" style="background-color: #f5f5f5;">
                <div class="portlet-title">
                  <div class="caption">
                    <i class="icon-social-dribbble font-green hide"></i>
                    <span class="caption-subject bold uppercase" style="color: #6b3e0d;">Evaluasi Final</span>
                  </div>
                </div>
                <div class="portlet-body">
                  <?php
                  ...
                  if(isset($_POST['submit'])){
                    ...
                    if ($_FILES['hasil_eval']['name'] == ""){
                      ...
                      if($ekstensi == $ekstensi_diperbolehkan){
                        ...
                        $query = mysqli_query($dbconnect,"UPDATE data_evaluasi SET hasil_eval_final = '$hasil_eval' WHERE id_pengusul='$id_pengusul'");
                        if($query){
                          ...
                          $quer1 = mysqli_query($dbconnect,"UPDATE data_evaluasi SET status_proposal='proses', status_lampiran = 'proses' WHERE id_pengusul= '$id_pengusul'");
                          $quer2 = mysqli_query($dbconnect,"INSERT INTO rekap_status VALUES ('$id_pengusul', now(), 'Hasil evaluasi diterima')");
                        }else{
                  ...
                  <form enctype="multipart/form-data" action="" method="post">
                    <div>
                      <h5 >Unggah Hasil Evaluasi Final</h5>
                  ...
                  <?php
                  $ef = mysqli_query($dbconnect, "SELECT hasil_eval_final FROM data_evaluasi WHERE id_pengusul='$id_pengusul'");
                  $dataef = mysqli_fetch_assoc($ef);
                  if ($dataef['hasil_eval_final'] != NULL) {
                    $folder = $dataa['id_pengusul']."-".$dataa['jenjang']."-".$dataa['nama'];
                    echo '
                    <h5><b>Hasil Evaluasi Oleh Evaluator</b></h5>
                    <p><a href="../on-pengusul/'.$folder.'/'.$dataef['hasil_eval_final'].'" download><img src="../img/d.png" width="1%;">  '.$dataef['hasil_eval_final'].'</a></p>';
                  }
                  ?>
                  ...
                  if (isset($_POST['ajukan'])) {
                    $quer3 = mysqli_query($dbconnect,"INSERT INTO rekap_status VALUES ('$id_pengusul', now(), 'Siap diajukan')");
                  }
                  if (isset($quer3)) {
                    echo '<div class="note note-success">Pengusulan siap diajukan.</div>';
                  }
                  ?>
                  <p>*<b>Silahkan diajukan jika tidak ada lagi perbaikan.</b></p>
                  <form action="" method="POST">
                    <button type="submit" name="ajukan" value="Siap diajukan" class="btn btn-circle btn-success">Siap Diajukan</button>
                    <span></span>
                  </form>
                ...
                <div class="col-md-12">
                  <div class="portlet light bordered" style="background-color: #f5f5f5;">
                    <div class="portlet-title">
                      <div class="caption">
                        <i class="icon-social-dribbble font-green hide"></i>
                        <span class="caption-subject bold uppercase" style="color: #6b3e0d;">Pengumuman Dari SILEMKERMA</span>
                      </div>
                    </div>
                    <div class="portlet-body" style="margin-bottom: 50px;">
                     <?php
                     if ($hCekStatus['status'] == 'Diterima' || $hCekStatus['status'] == 'Ditolak') {
                      ?>
                      <div class="col-md-2">
                        <button type="submit" name="status" value="ditolak" class="btn btn-circle btn-danger" disabled>Perlu perbaikan</button>
                      </div>
                      <div class="col-md-1">
                        <button type="submit" name="status" value="diterima" class="btn btn-circle btn-success" disabled>Diterima</button>
                      </div>
                      <?php
                    }else{
                      ?>
                      <div class="col-md-2">
                        <form action="index.php" method="POST">
                          <input type="hidden" name="id_pengusul" value="<?php echo $id_pengusul ?>">
                          <button type="submit" name="status" value="ditolak" class="btn btn-circle btn-danger">Perlu perbaikan</button>
                        </form>
                      </div>
                      <div class="col-md-1">
                        <form action="index.php" method="POST">
                          <input type="hidden" name="id_pengusul" value="<?php echo $id_pengusul ?>">
                          <button type="submit" name="status" value="diterima" class="btn btn-circle btn-success">Diterima</button>
                        </form>
                      </div>
                      <?php 
                    }
          ...
          <!-- <a type="button" href="index.php?status='ditolak'" class="btn btn-danger">Ditolak</a>
            <a type="button" href="index.php?status='diterima'" class="btn btn-success">Diterima</a> -->
